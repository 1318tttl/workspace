...
public class If {
	...
	/*
	   ...
	   : 기본적으로 프로그램은 순차적으로 진행 (위->아래, 왼쪽->오른쪽)
	     순차적인 흐름을 바꿀때 제어문(조건문,반복문, ..)을 사용하여 제어가능
	...
	*/
	...
	public static void method3() {
		...
		*/
        ...
        System.out.print("주민등록번호를 입력하세요 : "); // - 까지 글자수에 해당됨 
        ...
        if (number.length() != 14) {
            ...
            if (gender == '1' || gender == '3') { 
                System.out.println("남자입니다."); // 남자 코드는 1, 3
            } else if (gender == '2' || gender == '4') {
                System.out.println("여자입니다."); // 여자 코드는 2, 4
            } else {
                System.out.println("잘못 입력되었습니다.");
            }
        }
